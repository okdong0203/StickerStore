    ...
    <!--header-index 끝-->
        ...
        <div class="middle-index">
          ...
          <div class="midbox">
           ...
           <div class="id-find-text">비밀번호 찾기</div>
           ...
           <form action="passwordFindCheck.jsp" method="post" name="passwordFind">
             <input type="text" class="id-box" name="id" placeholder="     아이디  ex)abc123">
           
            

            <input type="text" class="name-box" name="name" placeholder="     이름 ex)홍길동">
